...
<!-- Hero Section -->
<div class="relative bg-cover bg-center h-[300px]" style="background-image: url('{{ asset('banner.png') }}');">
    <div class="absolute inset-0 bg-[#5E7CC7] bg-opacity-70 flex items-center">
        <div class="container mx-auto text-white px-6">
            ...
            <a href="{{ route('contact') }}" class="mt-6 inline-block bg-white text-blue-700 px-6 py-3 rounded-lg font-semibold shadow-md">
                Hubungi Kami
            </a>
        </div>
    </div>
